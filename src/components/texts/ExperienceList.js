      ...
      <div style={isMobile ? mobileParent : desktopParent}>
        <div style={textHolder}>
            ...
            <p style={paragraph}>
                ...
                I had the privilege of tutoring students across all undergraduate courses for the School of Computer Science. <br />
                <span style={tab} />
                This experience provided me with valuable opportunities to deepen my grasp of programming fundamentals, 
                as I needed to have a solid understanding in order to effectively explain concepts to others. <br />
                <span style={tab} />
        ...
        <div style={textHolder}>
            ...
            <p style={paragraph}>
                <span style={tab} />
                During my tenure at Paycom, I significantly bolstered my comprehension of programming fundamentals within a professional setting. <br />
                <span style={tab} />
                As part of the internship program, I engaged in structured reading and discussions centered on a book focusing on clean code principles. <br />
                <span style={tab} />
                Collaborating within sizable teams of interns, we successfully delivered projects within the designated internship duration.  <br />
                <span style={tab} />
        ...
        <div style={textHolder}>
            ...
            <p style={paragraph}>
                ...
                including OU AI, ACM, and MISSA. <br />
                <span style={tab} />
        ...
        <div style={textHolder}>
            ...
            <p style={paragraph}>
                <span style={tab} />
                I had the privilege of working at a local Oklahoma City shop where I gained invaluable insights into technology fundamentals. <br />
                <span style={tab} />
                I received hands-on training in assembling computers and diagnosing potential issues before, during, and after the build process. <br />
                <span style={tab} />
